...
loki-gateway <> loki-read (grafana + alert rules告警) <>  promrtheus > alertmanagement > webhook-adapter(国内通讯软件代理器 钉钉/企业微信/个人微信等)
loki-gateway >   loki-write (接收promtail日志并写入)  >  promrtheus  
